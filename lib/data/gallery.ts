...
const featuredImages: GalleryImage[] = [
  ...
  {
    id: "feat-toll-plaza-lineup",
    tone: "graphite",
    src: "/gallery/toll-plaza-lineup.jpg",
    alt: "Plan B riders lined up at the NH-544 toll plaza before flag-off",
    destination: "Salem",
    year: 2026,
    ride: "Heritage Run",
    size: "lg",
  ...
  {
    id: "feat-highway-convoy-formation",
    tone: "ember",
    src: "/gallery/highway-convoy-formation.jpg",
    alt: "Plan B convoy riding in formation on the open highway",
    destination: "Coimbatore",
    year: 2026,
    ride: "Sunday Convoy",
    size: "md",
  ...
  {
    id: "feat-planb-offroad-hills",
    tone: "racing",
    src: "/gallery/planb-offroad-hills.jpg",
    alt: "Riders in Plan B jackets on a dusty off-road trail with hills behind",
    destination: "Topslip",
    year: 2026,
    ride: "Trail Run",
    size: "md",
  ...
  {
    id: "feat-highway-group-approach",
    tone: "gold",
    src: "/gallery/highway-group-approach.jpg",
    alt: "The pack riding toward camera on an open highway",
    destination: "Ooty",
    year: 2026,
    ride: "Nilgiri Loop",
    size: "sm",
  ...
  {
    id: "feat-streetfighter-trio-palms",
    tone: "night",
    src: "/gallery/streetfighter-trio-palms.jpg",
    alt: "Three streetfighter motorcycles parked together under a palm tree",
    destination: "Coimbatore",
    year: 2026,
    ride: "Club Meet",
    size: "sm",
